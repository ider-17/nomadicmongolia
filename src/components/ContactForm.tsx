  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        disabled={isSending}
        className={`w-full text-sm font-medium border border-white py-2 px-4 rounded-md transition cursor-pointer
                    ${
                      isSending
                        ? "bg-gray-400 text-white cursor-not-allowed"
                        : "bg-[#2fa147] text-white hover:bg-white hover:text-[#2fa147] hover:border-[#2fa147] active:text-black active:bg-white"
                    }`}
      >
