...
export default async function SteppeGobiPage() {
  const tour = await getSteppeGobiPage();
  ...
  return (
    <div className="bg-white">
      ...
      <section className="w-full min-h-screen text-black px-[5%] pt-25 space-y-6 pb-6">
        ...
        {tour.laQuotaComprende.map((item: string, i: number) => (
        ...
        {tour.laQuotaNonComprende.map((item: string, i: number) => (
          <div key={i} className="flex gap-4">
            <p>✓</p>
            <p>{item}</p>
          </div>
...
//     day: 5,
//     title:
//       "ULAANBAATAR – LE DUNE DEL DESERTO DEI GOBI E BAYANZAG (80 km. circa)",
//     description:
...
//     id: 1,
//     description:
//       "Sistemazione: 4 notti in Hotel*** a Ulaanbaatar e 7 notti in Campi turistici nelle Gher durante il viaggio, sistemazione in camera doppia (singola a richiesta con supplemento) con bagni privati in hotel e con bagni condivisi nelle gher",
//   },
//   {
//     id: 2,
