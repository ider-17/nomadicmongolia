...
export default function ToursPage() {
  ...
  return (
    <div className="bg-white min-h-screen overflow-hidden">
      <Header />
      <section className="w-full h-fit sm:pt-22.5 pt-15 sm:px-37.5 px-[5%] space-y-8 mb-6">
        {TOURS.map((tour) => {
          return (
            <div
              key={tour.id}
            ...
            >
              <img
                loading="lazy"
                className="w-1/2 h-125 object-center object-cover rounded-2xl hidden sm:block"
                src={tour.photo}
              />
              ...
              <div className="sm:w-1/2 w-full pt-4">
                  ...
                  <div>
                    ...
                    <div className="flex gap-4 flex-wrap items-center">
                      {tour.locations
                        .slice(
                          0,
                          showAllLocations[tour.id] ? tour.locations.length : 3
                        )
                        .map((location, index) => (
                ...
                <img
                  loading="lazy"
                  className="w-full block sm:hidden h-125 object-center object-cover rounded-2xl mb-2"
                  src={tour.photo}
                />
